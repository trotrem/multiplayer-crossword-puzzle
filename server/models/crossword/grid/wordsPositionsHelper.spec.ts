...
describe("createListOfWord", () => {
    ...
    it("Should only add words longer than 2", () => {
        grid = { cells: [[{isBlack: false, letter: "", x: 0, y: 0}, {isBlack: false, letter: "", x: 1, y: 0}, {isBlack: false, letter: "", x: 2, y: 0}],
                         [{isBlack: false, letter: "", x: 0, y: 1}, {isBlack: true, letter: "", x: 1, y: 1}, {isBlack: false, letter: "", x: 2, y: 1}],
                         [{isBlack: false, letter: "", x: 0, y: 2}, {isBlack: false, letter: "", x: 1, y: 2}, {isBlack: true, letter: "", x: 2, y: 2}]], words: [], blackCells: [] };
        WordsPositionsHelper.createListOfWord(grid);
